...
def get_args():
  ...
  parser.add_argument('--input_size', type=int, default=784, help='dims of input data')
  parser.add_argument('--output_width', type=int, default=28, help="output image size")
  parser.add_argument('--input_channel', type=int, default=1, help="channels of input")
  parser.add_argument('--beta', type=int, default=1, help="beta")
  parser.add_argument('--K', type=int, default=20, help="number of embedding")
